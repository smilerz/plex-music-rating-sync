...
from manager.config_manager import ConfigManager, ConflictResolutionStrategy, LogLevel, PlayerType, TagWriteStrategy
...
def test_validate_config_requirements_missing_default(monkeypatch):
    monkeypatch.setattr("sys.argv", ["sync_ratings.py", "--source", "plex", "--destination", "filesystem", "--sync", "tracks", "--tag-write-strategy", "write_default"])
