...
class ConfigManager:
    ...
    def parse_args(self) -> configargparse.Namespace:
        ...
        self.parser.add_argument(
            "--tag-write-strategy", type=str, choices=["write_all", "write_existing", "write_default", "overwrite_default"], help="Strategy for writing rating tags to files"
        )
        self.parser.add_argument(
            "--default-tag", type=str, choices=["MEDIAMONKEY", "WINDOWSMEDIAPLAYER", "MUSICBEE", "WINAMP", "TEXT"], help="Canonical tag to use for writing ratings"
        )
        self.parser.add_argument(
